package es.gobcan.istac.statistical.operations.roadmap.external.api;
...
public class CXFConfiguration {
     ...
     */
    @Bean
    public Server jaxRsServer(final StatisticalOperationsV1_0 statisticalOperationsV10) {
        final JAXRSServerFactoryBean factory = new JAXRSServerFactoryBean();
        factory.setAddress("/operations");
        factory.setResourceProviders(getResourceProviders());
        factory.setServiceBean(statisticalOperationsV10);
