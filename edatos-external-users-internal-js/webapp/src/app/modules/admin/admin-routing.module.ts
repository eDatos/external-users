...
import { dataProtectionPolicyConfigurationRoutes } from './data-protection-policy/data-protection-policy.route';
...
export const adminRoutes: Routes = [auditsRoute, configurationRoute, healthRoute, logsRoute, metricsRoute, {
    ...
    children: dataProtectionPolicyConfigurationRoutes
}];
