...
public class NeedResourceTest {
    ...
    public void initTest() {
        newNeed = ExternalUsersDataTestsUtils.createEntity(ExternalUsersDataTestsUtils.NEED_CODE_1, ExternalUsersDataTestsUtils.LOCALISED_STRING, null);

        existingNeed = ExternalUsersDataTestsUtils.createEntity(ExternalUsersDataTestsUtils.NEED_CODE_2, ExternalUsersDataTestsUtils.LOCALISED_STRING, ProcStatusEnum.DRAFT);
        em.persist(existingNeed);

        internalPublishedNeed = ExternalUsersDataTestsUtils.createEntity(ExternalUsersDataTestsUtils.NEED_CODE_3, ExternalUsersDataTestsUtils.LOCALISED_STRING, ProcStatusEnum.INTERNALLY_PUBLISHED);
    ...
    public void createNeed() throws Exception {
        ...
        Assertions.assertThat(testNeed.getCode()).isEqualTo(ExternalUsersDataTestsUtils.NEED_CODE_1);
        Assertions.assertThat(testNeed.getUrn()).isEqualTo(GeneratorUrnUtils.generateSiemacStatisticalNeedUrn(
            ExternalUsersDataTestsUtils.NEED_CODE_1));
    ...
    public void createNeedRequiredMetadataError() throws Exception {
        {
            NeedEntity needEntity = ExternalUsersDataTestsUtils.createEntity(null, ExternalUsersDataTestsUtils.LOCALISED_STRING, ProcStatusEnum.DRAFT);
        ...
        {
            NeedEntity needEntity = ExternalUsersDataTestsUtils.createEntity(ExternalUsersDataTestsUtils.NEED_CODE_1, null, ProcStatusEnum.DRAFT);
        ...
        {
            NeedEntity needEntity = ExternalUsersDataTestsUtils.createEntity("NON_VALID_CODE!", ExternalUsersDataTestsUtils.LOCALISED_STRING, ProcStatusEnum.DRAFT);
    ...
    public void updateNeed() throws Exception {
        ...
        updatedNeed.setCode(ExternalUsersDataTestsUtils.NEED_CODE_UPDATE);
        updatedNeed.getTitle().addText(new LocalisedStringVO(ExternalUsersDataTestsUtils.LOCALISED_STRING_LABEL_UPDATE, ExternalUsersDataTestsUtils.LOCALISED_STRING_LOCALE_UPDATE));
        ...
        Assertions.assertThat(testNeed.getCode()).isEqualTo(ExternalUsersDataTestsUtils.NEED_CODE_UPDATE);
        Assertions.assertThat(testNeed.getUrn()).isEqualTo(GeneratorUrnUtils.generateSiemacStatisticalNeedUrn(
            ExternalUsersDataTestsUtils.NEED_CODE_UPDATE));
    ...
    public void getAllNeeds() throws Exception {
        ...
        restNeedMockMvc.perform(
            ...
            .andExpect(jsonPath("$.[*].code").value(Matchers.hasItems(ExternalUsersDataTestsUtils.NEED_CODE_2)))
            .andExpect(jsonPath("$.[*].urn").value(Matchers.hasItem(GeneratorUrnUtils.generateSiemacStatisticalNeedUrn(ExternalUsersDataTestsUtils.NEED_CODE_2))));
        // @formatter:on
    }
    ...
    public void getNeed() throws Exception {
        ...
        restNeedMockMvc.perform(
            ...
            .andExpect(jsonPath("$.code").value(ExternalUsersDataTestsUtils.NEED_CODE_2))
            .andExpect(jsonPath("$.urn").value(GeneratorUrnUtils.generateSiemacStatisticalNeedUrn(ExternalUsersDataTestsUtils.NEED_CODE_2)));
        // @formatter:on
    }
