package es.gobcan.istac.edatos.external.users.core.optlock;
...
import es.gobcan.istac.edatos.external.users.core.config.ApplicationContextProvider.AppContext;
import es.gobcan.istac.edatos.external.users.core.domain.interfaces.VersionedEntity;
