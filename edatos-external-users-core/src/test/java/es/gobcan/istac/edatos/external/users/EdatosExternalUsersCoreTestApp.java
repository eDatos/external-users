...
public class EdatosExternalUsersCoreTestApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(EdatosExternalUsersCoreTestApp.class);

    private final Environment env;

    public EdatosExternalUsersCoreTestApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EdatosExternalUsersCoreTestApp.class);
