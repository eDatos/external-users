...
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.LOCALISED_STRING_LABEL_UPDATE;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.LOCALISED_STRING_LOCALE_UPDATE;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.NEED_CODE_1;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.NEED_CODE_2;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.NEED_CODE_3;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.NEED_CODE_UPDATE;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.createEntity;
...
import es.gobcan.istac.statistical.operations.roadmap.core.domain.vo.LocalisedStringVO;
...
import es.gobcan.istac.statistical.operations.roadmap.internal.rest.resources.NeedResource;
