...
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.NEED_STATE_CODE_1;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.NEED_STATE_CODE_2;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.NEED_STATE_CODE_3;
import static es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils.NEED_STATE_CODE_NO_EXIST;
...
import es.gobcan.istac.statistical.operations.roadmap.internal.rest.mapper.NeedStateMapper;
import es.gobcan.istac.statistical.operations.roadmap.internal.rest.resources.NeedStateResource;
import es.gobcan.istac.statistical.operations.roadmap.internal.rest.util.RoadmapDataTestsUtils;
