...
import static es.gobcan.istac.statistical.operations.roadmap.util.StatisticalOperationsAsserts.assertEqualsExternalItem;
import static es.gobcan.istac.statistical.operations.roadmap.util.StatisticalOperationsAsserts.assertEqualsExternalItemCollectionMapper;
import static es.gobcan.istac.statistical.operations.roadmap.util.StatisticalOperationsMocks.mockExternalItem;
import static es.gobcan.istac.statistical.operations.roadmap.util.StatisticalOperationsMocks.mockExternalItemDto;
...
import es.gobcan.istac.statistical.operations.roadmap.core.repository.ExternalItemRepository;
...
public class ExternalItemMapperTest {
    ...
    private void testExternalItemDtoToEntity(ExternalItemDto externalItemDto, ExternalItemEntity externalItemEntity) throws Exception {
        ...
        assertEqualsExternalItem(result, externalItemDto, MapperEnum.DTO2ENTITY);
    }
    ...
    private void testExternalItemDtoListToEntitiesList(Set<ExternalItemDto> dtos, Set<ExternalItemEntity> entities) throws Exception {
        ...
        assertEqualsExternalItemCollectionMapper(result, dtos, MapperEnum.DTO2ENTITY);
    }
    ...
    private void testExternalItemDoToDto(ExternalItemEntity externalItem) throws Exception {
        ...
        assertEqualsExternalItem(externalItem, result, MapperEnum.ENTITY2DTO);
    }
    ...
    private void testExternalItemDoCollectionToDtoCollection(Set<ExternalItemEntity> entities) throws Exception {
        ...
        assertEqualsExternalItemCollectionMapper(entities, result, MapperEnum.ENTITY2DTO);
    }
}
