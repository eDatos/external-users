...
public class StatisticalOperationsRoadmapCoreTestApp {

    private static final Logger log = LoggerFactory.getLogger(StatisticalOperationsRoadmapCoreTestApp.class);

    private final Environment env;

    public StatisticalOperationsRoadmapCoreTestApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(StatisticalOperationsRoadmapCoreTestApp.class);
