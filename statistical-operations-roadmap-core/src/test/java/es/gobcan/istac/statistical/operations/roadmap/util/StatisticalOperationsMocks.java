...
public final class StatisticalOperationsMocks {
    ...
    public static OperationEntity mockOperation() {
        ...
        // ACRONYM
        InternationalStringEntity acronym = new InternationalStringEntity();
        LocalisedStringEntity acronym_es = new LocalisedStringEntity();
        acronym_es.setLabel("Acronynm en español de operación");
        acronym_es.setLocale("es");
        LocalisedStringEntity acronym_en = new LocalisedStringEntity();
    ...
    public static OperationEntity mockOperationForInternalPublishing(OfficialityTypeEntity officialityType, SurveyTypeEntity surveyType) {
        ...
        // OBJECTIVE
        InternationalStringEntity objective = new InternationalStringEntity();
        LocalisedStringEntity objective_es = new LocalisedStringEntity();
        objective_es.setLabel("OPERACION - OBJECTIVE - ES");
        objective_es.setLocale("es");
        LocalisedStringEntity objective_en = new LocalisedStringEntity();
